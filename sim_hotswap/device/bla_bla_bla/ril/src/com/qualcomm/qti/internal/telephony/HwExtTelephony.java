...
public class HwExtTelephony extends IExtTelephony.Stub {
    ...
    private void setRadionOn(int subId, boolean turnOn) {
        Log.d(TAG, "setRadionOn, turnOn: " + turnOn + ", subId = " + subId);
        boolean isSuccessful = false;
        if (!SubscriptionManager.isValidSubscriptionId(subId)) {
	    Log.d(TAG, "setRadionOn, isSuccessfuly NOT changet!!!");
            return;
        }
        ...
        try {
            if (telephony != null) {
                ...
                if (isSuccessful) {
                    Log.d(TAG, "setRadionOn, isSuccessfuly changet!!!");
                }
            } else {
	...
	Log.d(TAG, "activateUiccCard, slotId: " + slotId + " ,mStatus: " + sUiccStatus[slotId].mStatus);
	...
	Log.d(TAG, "deactivateUiccCard, slotId: " + slotId + " ,mStatus: " + sUiccStatus[slotId].mStatus);
	...
	Log.d(TAG, "deactivateUiccCard, slotId: " + slotId + " ,subIdToDeactivate: " + subIdToDeactivate + " ,subIdToMakeDefault: " + subIdToMakeDefault);
